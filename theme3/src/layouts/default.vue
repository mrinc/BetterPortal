...
import { BetterPortal } from '@bettercorp/betterportal-sdk';
import type { ServiceRouteExpanded } from '@bettercorp/betterportal-sdk';
import Author from '../components/Author.vue';
import { ComponentLoadType, type AppFeatures, type BPv2WhoAmIDefinition, type Component } from '@bettercorp/betterportal-sdk/lib/vue/3/appConfig';
import {
  VaCard,
  VaCardContent,
  VaInnerLoading
...
<template>
  <main>
    ...
    <div v-else-if="route.meta !== undefined && route.meta.hidewindow === true">
